...
const Reports: React.FC<ReportsProps> = ({ user }) => {
  ...
  const handleExport = () => {
    ...
    const headers = ['Tenant', 'Phone', 'Property', 'Rent', 'Expiry Date'];
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Gross Monthly Rent</p>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                ...
                <th className="px-6 py-4"><div className="flex items-center"><DollarSign className="w-3 h-3 mr-2" /> Rent Amount</div></th>
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-20 text-center">
                    <div className="flex flex-col items-center">
                      {/* Table icon fixed by import above */}
